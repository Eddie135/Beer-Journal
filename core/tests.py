...
class ProductionSettingsTests(TestCase):
    ...
    def test_base_template_includes_versioned_pwa_assets_and_manifest(self):
        ...
        self.assertContains(response, "css/app.css?v=20260714-f23")
        self.assertContains(response, "js/app.js?v=20260714-f23")
        self.assertContains(response, "beer-journal-favicon-v3.png")
        self.assertContains(response, 'rel="manifest"')
        self.assertContains(response, 'href="/manifest.json"')
        self.assertEqual(response.content.decode().count("data-tab-navigation"), 3)
    ...
    def test_pwa_manifest_declares_standalone_app_and_required_icons(self):
        ...
        self.assertEqual(manifest["start_url"], "/beers/")
    ...
    def test_manifest_is_public_at_root_with_correct_content_type(self):
        ...
        self.assertEqual(manifest["name"], "Beer Journal")
        self.assertEqual(manifest["display"], "standalone")
        self.assertTrue(any("beer-journal-icon-512-v3.png" in icon["src"] for icon in manifest["icons"]))
    ...
    def test_service_worker_caches_only_static_app_shell_and_never_private_records(self):
        ...
        self.assertIn("beer-journal-shell-v7", content)
        self.assertIn("/static/css/app.css?v=20260714-f23", content)
        ...
        self.assertIn("data-tab-navigation", script)
        self.assertIn("startViewTransition", script)
